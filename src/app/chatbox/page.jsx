  ...
  return (
    <div className='bg-primary-subtle vh-100'>
        <div className='container py-5' >
            ...
            <h1 className='display-3 fw-bold text-center' > Chaty </h1>

            <div className='card shadow' >
                <h6 className='text-center ' ></h6>
                <div className='card-header py-4' > 
                    <input onKeyDown={addNewTask} type="text" className='form-control w-75 mx-auto border-3 border-primary' placeholder='Send a message '/>
                </div>
                <div className='card-body' >
                    {
                        taskList.map(  (task, index) => { 
                            return <div key={index} className='p-3 shadow mb-3 d-flex justify-content-between align-items-center' >
                                ...
                                <button onClick={ () => {deleteTask(index)} } className='btn btn-dan  ger' >Delete</button>
